  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        gradient_hero:
          "linear-gradient(to bottom, rgba(0,0,0,0.60) 10%, rgba(0,0,0,0.35) 55%, rgba(0,0,0,0.15) 90%)",
        avatar_bg: "url('/img/background-header.jpg')",
      },
      maxWidth: {
        box_max: "480px",
        box_max_mobi: "350px",
