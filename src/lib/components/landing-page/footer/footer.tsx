      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10">
          ...
          <div className="space-y-4 text-center sm:text-left">
            ...
            <p className="text-slate-400 text-sm leading-6 max-w-md mx-auto sm:mx-0">
          ...
          {/* Cột 4 & 5 */}
          <div className="space-y-4 col-span-1 sm:col-span-2 text-center sm:text-left">
            <h3 className="text-white font-semibold">Stay Connected</h3>
            <div className="space-y-2 text-sm text-slate-300">
              <div className="flex flex-col sm:flex-row justify-center sm:justify-start items-center sm:items-start gap-2 sm:gap-3">
              ...
              <div className="flex flex-col sm:flex-row justify-center sm:justify-start items-center sm:items-start gap-2 sm:gap-3">
                ...
                <span className="max-w-[250px] sm:max-w-none text-center sm:text-left">
                  41 Phan Van Tri St, District Go Vap, Ho Chi Minh City
                </span>
              </div>
            </div>
            ...
            <div className="space-y-2 mt-4 sm:mt-0">
              ...
              <form className="flex flex-col sm:flex-row items-center gap-3 w-full max-w-md mx-auto sm:mx-0">
                <input
                  type="email"
                  required
                ...
                <button
                  type="submit"
                  className="w-full sm:w-auto inline-flex justify-center items-center rounded-md bg-brand px-4 py-2 text-sm font-semibold text-white hover:opacity-90"
                >
                  Subscribe
                </button>
              </form>
        ...
        {/* Dòng dưới cùng */}
        <div className="mt-10 sm:mt-12 border-t border-footer-border pt-6 sm:pt-8 flex flex-col sm:flex-col md:flex-row items-center justify-center md:justify-between gap-4 sm:gap-6 text-center md:text-left">
          ...
          <nav className="flex flex-wrap justify-center md:justify-end items-center gap-4 sm:gap-6 text-xs">
